...
<form method="POST" class="anil-form  anil-form-aligned" >
	  ...
	  <button id="saveEvent" name="submit" type="button" class="anil-button anil-button-primary">Event Completed</button>
...
you can take pride in helping to transform our urban landscapes.
      ...
      <form class="anil-form  anil-form-aligned" >  
       <div class="pure-control-group">
	     ...
	     <input id="rqsearch" type="text"  name="search_field" placeholder="Enter RequestID...." >
